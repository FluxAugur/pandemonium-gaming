...
<body>
    ...
    <div class="wrapper">
        <div id ="show"> <!--NOTE for TEMPLATE: this is where real content goes, lower content divs are for
            ...
            <div class="area"> 
                  <h1>Media</h1>
                  <p>PGC is dedicated to providing quality video footage of our events, as well as promotial videos, and assorted other videos from around the web. <p>We plan on doing live broadcasts of our events using popular streaming services as well as archiving footage of our broadcasts. </p><p>For now check out our links to social media, which are located under the login panel at the top of the page.</p><br /><div id="t"><a href="http://www.twitch.tv/pgc1337">Visit Our Twitch</a></div>
            </div> <!--End area div-->
        </div><!--End show div-->

            <!--iframe for the top index content-->
            <iframe width="600" height="338" src="http://www.youtube.com/embed/i5brCu6NHgY" frameborder="0" allowfullscreen></iframe>
