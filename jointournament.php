...
include("includes/tournamentconfirm.php"); //processes the tournament registration
?>
<!DOCTYPE html>
    ...
    <div class="wrapper">
        <div id="stack">
            <div class="accordion vertical">
            	...
            	<!--insert code here to draw atournament table-->
                
              	<?PHP 
				  	$id = $_GET["tourn_id"];
					$sql = "SELECT * from onlinetournament WHERE id_num = $id"; 
					include("includes/drawtournamenttable.php");
					include("drawtournamentregister.php");
				?>
                
                
              
        	</div><!--End stack div-->
        </div><!--End accordian vertical div-->
                <!--TWITTER DIVIDER BAR-->
