<?php
	...
	mysql_connect("pandemoniumstats.pandemoniumgaming.net", "rogha189", "Wh1stler") or die(mysql_error());
	mysql_select_db("pgcinfo") or die(mysql_error());
	...
	//build the table
	echo "<tr><td colspan=7 align=\"center\"><h1><a href=\"previousMonth.php?month=$month&year=$year\"><</a> $title $year <a href=\"nextMonth.php?month=$month&year=$year\">></a></h1></td></tr>";
	...
	{
		echo "<td align=\"left\" valign=\"top\"> $day_num <br />";
