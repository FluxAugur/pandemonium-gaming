...
<body>
    ...
    <div class="wrapper">
            <div id="about">
                <h1>User Profile - <?PHP echo $_SESSION['username']?></h1>
                <p><?PHP include("includes/creditcheck.php"); ?></p>
                <form>
                	<input type="button" class="button" onClick="location.href='resetpw.php'" value="Reset Password" />
                	<input type="button" class="button" onClick="location.href='editprofile.php'" value="Update User Info" />
          			<input type="button" class="button" onClick="location.href='#'" value="Buy Credits" /> 
	            </form>	
            </div> <!--End About Div-->
